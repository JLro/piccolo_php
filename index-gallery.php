...
<body class="home">
    ...
    <?php
    $fotografias = array(
        array('identificador' => 1, 'foto' =>'foto1', 'titulo' => 'titulo numero1'),
        array('identificador' => 2, 'foto' =>'foto2', 'titulo' => 'titulo numero2'),
        array('identificador' => 3, 'foto' =>'foto3', 'titulo' => 'titulo numero3'),
    );
    ?>
        <!-- Gallery Thumbnails
        ================================================== -->
